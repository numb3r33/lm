...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'lm'},
  'syms': { 'lm.bpe_tokenizer_class': { 'lm.bpe_tokenizer_class.Tokenizer': ( 'bpe_tokenizer_class.html#tokenizer',
                                        ...
                                        'lm.bpe_tokenizer_class.Tokenizer.from_files': ( 'bpe_tokenizer_class.html#tokenizer.from_files',
                                                                                         'lm/bpe_tokenizer_class.py')},
            'lm.bpe_training': {'lm.bpe_training.train_bpe': ('bpe_training.html#train_bpe', 'lm/bpe_training.py')},
